...
// blackjack: total coins staked (non-spendable until maturity)
...
// BlackJack: get current stake weight
...
// blackjack: check 'spent' consistency between wallet and txindex
// blackjack: fix wallet spent state according to txindex
...
// blackjack: disable transaction (only for coinstake)
