...
namespace Checkpoints
{
    ...
    // blackjack: synchronized checkpoint (centrally broadcasted)
    ...
    // blackjack: get last synchronized checkpoint
    ...
    // blackjack: only descendant of current sync-checkpoint is allowed
    ...
    // blackjack: reset synchronized checkpoint to last hardened checkpoint
...
// blackjack: sync-checkpoint master key
...
// blackjack: verify signature of sync-checkpoint message
...
// blackjack: process synchronized checkpoint
