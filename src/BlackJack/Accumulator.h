 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator and AccumulatorWitness classes for the BlackJack library.
 *
...
public:
	 ...
	 * @throw      BlackJack exception in case of invalid parameters
	 **/
	 ...
	 *
	 * @throw		BlackJack exception if the coin is not valid.
	 *
	 **/
	...
	//  * @throw  A BlackJackException if the accumulator value is invalid.
	//  */
