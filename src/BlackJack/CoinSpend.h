 ...
 * @file       CoinSpend.h
 *
 * @brief      CoinSpend class for the BlackJack library.
 *
...
/** The complete proof needed to spend a BlackJack.
...
public:
	...
	/**Generates a proof spending a BlackJack.
	 *
	 ...
	 * @throw BlackJackException if the process fails
	 */
