...
* @file       Params.h
*
* @brief      Parameter classes for BlackJack.
*
...
public:
	/** @brief Construct a set of BlackJack parameters from a modulus "N".
	* @param N                A trusted RSA modulus
	* @param securityLevel    A security level expressed in symmetric bits (default 80)
	*
	* Allocates and derives a set of BlackJack parameters from
...
public:
	...
	**/
	Params(Bignum accumulatorModulus,
	       uint32_t securityLevel = BLACKJACK_DEFAULT_SECURITYLEVEL);
